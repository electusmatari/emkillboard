...
<table class="kb-table" width="360" cellpadding="0" cellspacing="1" border="0">
	<tr class="{cycle name=ccl}">
		...
		<td rowspan="3" width="64"  onClick="CCPEVE.showPreview({$victimShipID})"><img src="{$victimShipImg}" border="0" width="64" height="64" alt="victim" /></td>
	...
	<tr class="{cycle name=ccl}">
		...
		<td colspan="2" class="kb-table-cell"><b><a href="javascript:CCPEVE.showInfo({$victimShipID})">{$victimShipName}</a></b> ({$victimShipClassName})</td>
	</tr>
	<tr class="{cycle name=ccl}">
